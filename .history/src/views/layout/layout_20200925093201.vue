<template>
 <div class="d-f">
  <div>
    <a-menu
      v-model:selectedKeys="$route.path"
      style="width: 256px"  :theme="theme"
      mode="vertical" v-for="(item,index) in arr" :key="index"
    >
      <a-menu-item :key="index" @Click="titleClick(item)">
